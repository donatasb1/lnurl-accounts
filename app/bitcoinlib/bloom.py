...
class CBloomFilter(app.bitcoinlib.core.serialize.Serializable):
    ...
    def insert(self, elem):
        ...
        """
        if isinstance(elem, app.bitcoinlib.core.COutPoint):
            elem = elem.serialize()
    ...
    def stream_deserialize(cls, f):
        vData = bytearray(app.bitcoinlib.core.serialize.BytesSerializer.stream_deserialize(f))
        (nHashFuncs,
         nTweak,
         nFlags) = CBloomFilter.__struct.unpack(app.bitcoinlib.core.ser_read(f, CBloomFilter.__struct.size))
    ...
    def stream_serialize(self, f):
        app.bitcoinlib.core.serialize.BytesSerializer.stream_serialize(self.vData, f)
