...
class FakeBitcoinProxy(object):
    ...
    def _call(self, rpc_method_name, *args, **kwargs):
        ...
        python-app.bitcoinlib does not parse.
        """
    ...
    def getblock(self, blockhash, *args, **kwargs):
        ...
        # python-app.bitcoinlib returns a CBlock object, not a dictionary.
    ...
    def _batch(self, batch_request_entries):
        ...
        feature found in python-app.bitcoinlib and bitcoind RPC.
        """
