...
from app.bitcoinlib.segwit_addr import encode, decode
...
class CBech32Data(bytes):
    ...
    def __new__(cls, s):
        """from bech32 addr to """
        witver, data = decode(app.bitcoinlib.params.BECH32_HRP, s)
    ...
    def __str__(self):
        """Convert to string"""
        return encode(app.bitcoinlib.params.BECH32_HRP, self.witver, self)
